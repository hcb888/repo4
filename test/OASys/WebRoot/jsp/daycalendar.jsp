...
<html>
  <head>
    ...
    <title>My JSP 'daycalendar.jsp' starting page</title>
	...
	<div class="col-md-12">
		<div class="box">
			<div class="box-header">
				<h3 class="box-title">
					<a class="label label-success" href="dayadd.html"><span
	...
	$(document).ready(function() {
		...
		$('#calendar').fullCalendar({
			...
			events:function(start, end, callback){
				$.ajax({
					 url: "mycalendar.json",//静态页面展示使用,动态网页开发时改成实际的请求路径
					 cache:false,
					 dataType:'jsonp',//静态页面展示使用,动态网页开发时改成json
					 jsonp:"callback",//静态页面展示使用,动态网页开发时去掉此项
					 jsonpCallback:"calendar",//静态页面展示使用,动态网页开发时去掉此项
