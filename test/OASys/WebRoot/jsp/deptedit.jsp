...
<body style="background-color: #ecf0f5;">
	...
	<div class="row" style="padding-top: 15px;">
		<div class="col-md-12">
			<!--id="container"-->
			<div class="bgc-w box">
				<form action="deptController/update.action" method="post" onsubmit="return check();">
						...
						<div class="box-body">
							...
							<div class="row">
								<div class="col-md-6 form-group">
									...
									<input type="hidden" name="deptmanager" value="${dept.deptmanager}">
							    ...
							    <div class="col-md-6 form-group">
									...
									<input  name="startDate" type="text" class="demo-input" placeholder="请选择时间" id="startTime">
								</div>
								<div class="col-md-6 form-group">
									<label class="control-label"><span>下班时间</span></label> 
									<input  name="endDate" type="text" class="demo-input" placeholder="请选择时间" id="endTime">
								</div>  
