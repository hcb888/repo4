...
<html>
  <head>
    ...
    <title>My JSP 'eveserach.jsp' starting page</title>
		...
		<div class="bgc-w box">
			...
			<div class="box-header">
				...
				<tr >
					...
					<td colspan="7" class="underline" style="width:160px;"><div class="bottom" ><label class="control-label">${evection.process.processName}</label></div></td>
					<td class="css" style="width:30px;"></td>
					
					<td class="wi" style="width: 72px;"><label class="control-label">紧急程度</label></td>
					<td colspan="4" class="underline" style="width: 60px;"><div class="bottom">${evection.process.processType.typeName}</div></td>
					
				</tr>
				<tr >
					<td class="wi"  style="width: 100px;"><label class="control-label">提单人员</label></td>
					<td  style="width:140px;"><div class="bottom">${evection.process.processUser.userName}</div></td>
					<td class="css"style="width:30px;"></td>
					<td class="wi" style="width:90px;"><label class="control-label">提单部门</label></td>
					<td colspan="4" style="width:44px;"><div class="bottom">${evection.process.processUser.dept.deptName}</div></td>
					<td class="css" style="width:30px;"></td>
					<td class="wi"><label class="control-label">提单日期</label></td>
					<td colspan="4" ><div class="bottom">${evection.process.applyDate}</div></td>
				...
				<tr class="rile two">
					...
					<td  style="width:170px;"><div class="bottom">${evection.process.startDate}</div></td>
					<td class="css"style="width:30px;"></td>
					<td class="wi" style="width:90px;"><label class="control-label">结束日期</label></td>
					<td colspan="4" style="width:108px;"><div class="bottom">${evection.process.endDate}</div></td>
					<td class="css" style="width:30px;"></td>
					<td class="wi"><label class="control-label">出差天数</label></td>
					<td colspan="4" ><div class="bottom">${evection.process.procseeDays}</div></td>
				</tr>
				
				<tr class="rile">
					<td class="wi" style="width:100px;"><label class="control-label">相关资料</label></td>
					<td  style="width:140px;"><div class="bottom">
						<a href="http://localhost:8080/upload/${evection.process.proFile.attachmentPath}" class="label xiugai yulan" title="图片预览">
						<span class="glyphicon glyphicon-search"></span> 预览</a>
						<a href="http://localhost:8080/upload/${evection.process.proFile.attachmentPath}" class="label xiugai">
						...
						<div  class="out" style="height:84px;">
							<table class="table ob ">
								<tr>
									...
									<td colspan="13"><p style="margin-top: 20px;font-size:16px;">${evection.process.processDes}</p></td>
								</tr>
							</table>
						</div>
					</td>
					...
					<td colspan="14" style="text-align: right;" >
						<div class="pull-right foot">
							...
							<a class="btn btn-default fault" onclick="javascript:window.print();">
								...
								<a class="btn btn-primary huifu" href="evectionmoneyController/process.action?evectionId=${evection.process.processId}">
...
<script>
	$(function(){
		...
		$('.yulan').popover({
    		...
    		+'<h3 class="popover-title"></h3><div><img src="show//2019/01/Jack/35e14854-611d-49f5-83f4-ac043df9e131.jpg"style="max-width: 200px;"/></div><div class="popover-content"></div></div>'
    	})
	});
</script>
  </body>
