...
<html>
  <head>
    ...
    <title>My JSP 'holiserch.jsp' starting page</title>
		...
		<div class="bgc-w box">
			...
			<div class="box-header">
				...
				<tr >
					...
					<td colspan="7" class="underline" style="width:160px;"><div class="bottom" ><label class="control-label">${holiday.process.processName}</label></div></td>
					<td class="css" style="width:30px;"></td>
					
					<td class="wi" style="width: 72px;"><label class="control-label">紧急程度</label></td>
					<td colspan="4" class="underline" style="width: 60px;"><div class="bottom">${holiday.process.processType.typeName}</div></td>
					
				</tr>
				<tr >
					<td class="wi"  style="width: 100px;"><label class="control-label">提单人员</label></td>
					<td  style="width:140px;"><div class="bottom">${holiday.process.processUser.userName}</div></td>
					<td class="css"style="width:30px;"></td>
					<td class="wi" style="width:90px;"><label class="control-label">提单部门</label></td>
					<td colspan="4" style="width:44px;"><div class="bottom">${holiday.process.processUser.dept.deptName}</div></td>
					<td class="css" style="width:30px;"></td>
					<td class="wi"><label class="control-label">提单日期</label></td>
					<td colspan="4" ><div class="bottom">${holiday.process.applyDate}</div></td>
				...
				<tr class="rile two">
					...
					<td  style="width:170px;"><div class="bottom">${holiday.process.startDate}</div></td>
					<td class="css"style="width:30px;"></td>
					<td class="wi" style="width:90px;"><label class="control-label">结束日期</label></td>
					<td colspan="4" style="width:108px;"><div class="bottom">${holiday.process.endDate}</div></td>
					<td class="css" style="width:30px;"></td>
					<td class="wi"><label class="control-label">请假天数</label></td>
					<td colspan="4" ><div class="bottom">${holiday.process.procseeDays}</div></td>
				</tr>
				...
				<tr class="rile">
					...
					<td  style="width:140px;"><div class="bottom">${holiday.holidayType.typeName}</div></td>
					<td class="css" style="width:30px;"></td>
					<td class="wi"><label class="control-label">相关资料</label></td>
					<td  style="width:140px;"><div class="bottom">
						<a href="http://localhost:8080/upload/${holiday.process.proFile.attachmentPath}" class="label xiugai yulan" title="图片预览">
						<span class="glyphicon glyphicon-search"></span> 预览</a>
						<a href="http://localhost:8080/upload/${holiday.process.proFile.attachmentPath}" class="label xiugai">
						...
						<div  class="out" style="height:84px;">
							<table class="table ob ">
								<tr>
									...
									<td colspan="13"><p style="margin-top: 20px;font-size:16px;">${holiday.process.processDes}</p></td>
								</tr>
							</table>
						</div>
					</td>
