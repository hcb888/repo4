...
<div class="row" style="padding-top: 15px;">
	<div class="col-md-12">
		...
		<div class="bgc-w box">
			...
			<form action="noticeController/add.action" method="post" id="thisForm" onsubmit="return check();">
				<!--盒子身体-->
						...
						<div class="row">
							...
							<div class="col-md-6 form-group">
								<label class="control-label"><span>置顶</span></label><br>
										<span class="labels"><label><input name="isTop" value="1" type="checkbox"><i>✓</i></label></span>
							</div>
						</div>
				</div>
				</div>
