...
<script>
  ...
  <body>
		...
		<div class="containers">
			...
			<form action="taskController/myUpdateStatusAndTicking.action" method="post">
				<div class="row">
					<div class="box-body"
						...
						<div class="col-md-6 form-group">
							...
							</label> <input name="loggerTicking" type="text"   class="form-control" /> 
							<input name="task.taskId" type="text" id="ctl00_cphMain_txtPowerValue" class="form-control" value="${task.taskId }" style="display: none;" />
							<input name="pkId" type="hidden" value="${tuId}">	
						</div>
					</div>
