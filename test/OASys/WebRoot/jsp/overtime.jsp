...
<div class="row" style="padding-top: 15px;">
	<div class="col-md-12">
		...
		<div class="bgc-w box">
			<form action="overtimeController/add.action" enctype="multipart/form-data" method="post" onsubmit="return check();" >
			<div class="box-header">
				...
				<tr >
					...
					<td colspan="6">
						<select class="form-control inpu" name="overtimeType.typeId">
				...
				<tr >
					...
					<tr >
					 ...
					 <td class="title" ><label class="control-label">加班原因</label></td>
