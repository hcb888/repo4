...
<html>
  <head>
    ...
    <title>My JSP 'planedit.jsp' starting page</title>
...
.box .box-body .row .ischeck{
  ...
  <body >
		<div class="box increase">
			<form action="planController/update.action" method="post" onsubmit="return check();" enctype="multipart/form-data">
			<input type="text" name="planId" value="${plan.planId}">
			...
			<div class="box-body">
					...
					<div class="col-md-6 form-group">
						...
						<select class="form-control plantype" onchange="dochange(); " name="palnType.typeId">
								<c:forEach items="${planType}" var="type">
									<c:if test="${type.typeId==plan.palnType.typeId}">
					...
					<div class="col-md-6 form-group">
						...
						<select class="form-control" name="planStatus.statusId">
								 <c:forEach items="${planStatus}" var="status">
										<c:if test="${status.statusId==plan.planStatus.statusId}">
				...
				<div class="row">
					<div class="col-md-6 form-group">
						...
						<input class="form-control" id="starTime" name="startDate" value="${plan.startDate}"/>
					</div>
					<div class="col-md-6 form-group">
						<label class="control-label">结束时间</label>
						<input class="form-control" id="endTime" name="endDate" value="${plan.endDate}"/>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-6 form-group">
						...
						<input class="form-control" name="title" value="${plan.title}"/>
					</div>
					<div class="col-md-6 form-group" style="position: relative;">
						<label class="control-label">标签</label>
						<input class="form-control" name="label" value="${plan.label}"/ >
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-6 form-group">
						...
						<textarea class="form-control text" placeholder="至少20个字" name="planContent" >${plan.planContent}</textarea>
					</div>
					<div class="col-md-6 form-group">
						<label class="control-label">总结</label>
						<textarea class="form-control text" placeholder="至少20个字" name="planSummary" >${plan.planSummary}</textarea>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-6 form-group">
						...
						<textarea  disabled="disabled" class="form-control text" name="planComment" >${plan.planComment}</textarea>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6 form-group">
