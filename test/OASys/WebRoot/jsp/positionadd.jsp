...
<html>
  <head>
	...
	<script type="text/javascript">
		$(function(){
			$.ajax({
				url:"deptController/jsonFindList.action",
				type:"post",
				success:function(data){
					var deptService="";
					for(var i=0;i<data.length;i++){
						deptService+="<option value='"+data[i].deptId+"'>"+data[i].deptName+"</option>";
					}
					//先清空
					$("#dept").empty();
					//添加
					$("#dept").append(deptService);
				}
			});
		});
	</script>
...
<body style="background-color: #ecf0f5;">
	...
	<div class="row" style="padding-top: 15px;">
		<div class="col-md-12">
			<!--id="container"-->
			<div class="bgc-w box">
				<form action="positionController/add.action" method="post" onsubmit="return check();">
					<!--盒子头-->
						...
						<div class="box-body">
							...
							<div class="row">
								...
								<div class="col-md-6 form-group">
									...
									<select class="deptselect form-control" name="deptid" id="dept"></select>
								</div>
								<div class="col-md-6 form-group">
