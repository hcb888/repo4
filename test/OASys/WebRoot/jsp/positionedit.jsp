...
<html>
  <head>
    ...
    <title>My JSP 'positionedit.jsp' starting page</title>
  ...
  <body style="background-color: #ecf0f5;">
	...
	<div class="row" style="padding-top: 15px;">
		<div class="col-md-12">
			<!--id="container"-->
			<div class="bgc-w box">
				<form action="positionController/update.action" method="post" onsubmit="return check();">
					<!--盒子头-->
						...
						<div class="box-body">
							...
							<div class="row">
								<div class="col-md-6 form-group">
									...
									<input name="positionId" type="hidden" value="${position.positionId}">
								</div>
								<div class="col-md-6 form-group">
								...
								<div class="col-md-6 form-group">
									...
									<select class="deptselect form-control" name="deptid">
											<c:forEach items="${depts}" var="dept">
												<c:if test="${dept.deptId==position.deptid}">
