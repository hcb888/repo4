...
<html>
  <head>
    ...
    <title>My JSP 'positionmanage.jsp' starting page</title>
	...
	<div class="col-md-12">
		...
		<div class="bgc-w box box-primary">
			...
			<div class="box-header">
				<h3 class="box-title">
					<a href="jsp/positionadd.jsp" class="label label-success" style="padding: 5px;">
				...
				<div class="table-responsive">
					<table class="table table-hover table-striped">
						...
						<c:forEach var="postion" items="${positionList}">
							<tr>
								<td><span>${postion.name}</span></td>
								<td><span>${postion.level}</span></td>
								<td><span>${postion.describtion}</span></td>
								<td><a  href="positionController/findById.action?id=${postion.positionId}" class="label xiugai"><span
