...
<html>
  <head>
    ...
    <title>My JSP 'regular.jsp' starting page</title>
...
<div class="row" style="padding-top: 15px;">
	<div class="col-md-12">
		...
		<div class="bgc-w box">
			<form action="regularController/add.action" method="post" onsubmit="return check();" >
			<div class="box-header">
				...
				<tr >
					...
					<td  colspan="6"><input type="text" class="form-control inpu zhuanstart"  name="startDate"/></td>
					<td class="title" ><label class="control-label">结束日期</label></td>
					<td  colspan="6"><input type="text" class="form-control inpu zhuanend" name="endDate"/></td>
				</tr>
				<tr >
				...
				<tr >
					...
					<td  colspan="6"><textarea class="form-control text" name="regularAdvice"></textarea></td>
				</tr>
				<tr >
