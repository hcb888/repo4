...
<div class="row" style="padding-top: 15px;">
	<div class="col-md-12">
		...
		<div class="bgc-w box">
			<form action="resignController/add.action"  method="post" onsubmit="return check();" >
			<div class="box-header">
				...
				<tr >
					...
					<td  colspan="6">
					<input type="hidden" name="resignHandUser.userId" id="bursementUserId">
				...
				<tr >
					...
					<td  colspan="6" style="text-align:left;"><span class="labels"><label><input type="checkbox" value="1" name="isFinish" class="val" ><i>✓</i></label></span></td>
