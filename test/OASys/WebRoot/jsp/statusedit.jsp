...
<html>
  <head>
    ...
    <title>My JSP 'statusedit.jsp' starting page</title>
...
<div class="row" style="padding-top: 15px;">
	<div class="col-md-12">
		...
		<div class="bgc-w box">
			...
			<form action="statusController/update.action" method="post" onsubmit="return check();">
			<!--盒子身体-->
			<div class="box-body no-padding">
				<div class="box-body">
						...
						<div class="col-md-6 form-group">
							...
							<input class="form-control" name="sortValue" value="${status.sortValue}"/>
						</div>
						<div class="col-md-6 form-group">
