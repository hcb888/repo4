...
<html>
  <head>
    ...
    <title>My JSP 'typeedit.jsp' starting page</title>
...
<div class="row" style="padding-top: 15px;">
	<div class="col-md-12">
		...
		<div class="bgc-w box">
			...
			<!--盒子身体-->
			<form method="post" action="typeController/update.action" onsubmit="return check();">
				...
				<div class="alert alert-danger alert-dismissable" role="alert"
					...
					<div class="row">
						<div class="col-md-6 form-group">
							...
							<input class="form-control" name="typeModel" value="${type.typeModel}"/>
						</div>
						<div class="col-md-6 form-group">
							<label class="control-label"><span>类型</span></label>
							<input class="form-control" name="typeName" value="${type.typeName}"/>
						</div>
						<div class="col-md-6 form-group">
							<label class="control-label"><span>排序值</span></label> 
							<input type="number" min="0" class="form-control" name="sortValue" value="${type.sortValue}"/>
						</div>
						<div class="col-md-6 form-group">
							<label class="control-label"><span>颜色</span></label>
							<input  class="form-control" name="typeColor" value="${type.typeColor}"/>
						</div>
				</div>
			</div>
		</div>
